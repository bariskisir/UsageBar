...
internal static class Program
{
    ...
    private static void Main()
    {
        ...
        try
        {
            Log.Information("Usage Bar starting. Version={Version}; OS={OS}; Architecture={Architecture}; MinimumLogLevel={MinimumLogLevel}; HttpBodyLogging={HttpBodyLogging}.", typeof(Program).Assembly.GetName().Version?.ToString() ?? "unknown", Environment.OSVersion.VersionString, System.Runtime.InteropServices.RuntimeInformation.ProcessArchitecture, LogConfiguration.MinimumLevel, LogConfiguration.IsHttpBodyLoggingEnabled);
