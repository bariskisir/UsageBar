...
internal static class ProviderHttp
{
    ...
    /// </summary>
    public static async Task<JsonDocument> GetJsonAsync(HttpClient httpClient, HttpRequestMessage request, CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    public static async Task<JsonDocument> GetJsonWithBearerAsync(HttpClient httpClient, string url, string apiKey, CancellationToken cancellationToken)
    {
