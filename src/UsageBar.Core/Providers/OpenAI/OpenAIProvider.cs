...
{
    public override ProviderDescriptor Descriptor { get; } = new("OpenAI", 105, ProviderAuthenticationKind.ApiKey, CredentialNames.OpenAI, SettingsOrder: 10, IconKey: "openai");
