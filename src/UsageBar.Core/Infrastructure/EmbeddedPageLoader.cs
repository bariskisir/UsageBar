...
{
    public static string Load(Assembly assembly, string htmlResource, string cssResource, string scriptResource, string cssToken, string scriptToken) => Read(assembly, htmlResource).Replace(cssToken, Read(assembly, cssResource), StringComparison.Ordinal).Replace(scriptToken, Read(assembly, scriptResource), StringComparison.Ordinal);
